...
def show_ruutringis():
    canvas = Canvas(root, width=600, height=600, background="#630202")
    k=7
    x0=0
    y0=0
    x1=550
...
create_flag_button("Шахматное поле", show_malevaljak)
create_flag_button("Разноцветный овал", show_oval)
create_flag_button("Светофор", show_valgusfloor)
create_flag_button("Квадрат в круге", show_ruutringis)
root.mainloop()
